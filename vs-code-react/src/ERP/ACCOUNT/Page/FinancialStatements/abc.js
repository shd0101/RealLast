...
return (
    <React.Fragment>
        <Grid item xs={12}>
        <font color="green" size="50" face="돋움체">(❤'◡'❤) 😀재무상태표🍕 💢┗|｀O′|┛💢</font> 
        <br/>
        <br/>       
        <TextField
        type="date"
        ...
        onChange={onChange}        
         />        
        <Button variant="contained" color="primary" startIcon={<FindInPageIcon/>} style={buttonsize} onClick={searchData}>조회</Button>
        <br/>             
        </Grid>
        <div
